                    ...
                    <form method="POST" action="{{ route('admin.users.update', $user) }}">
                        ...
                        <div id="student-fields" style="display: {{ $user->role === 'student' ? 'block' : 'none' }};">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="registration_number" name="registration_number" value="{{ $user->username }}" placeholder="MOCU/BBICT/1089/23">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="student_phone" name="phone" value="{{ $user->phone }}" placeholder="0699889430">
                            ...
                            <div class="alert alert-info">
                                ...
                                Changing registration number will regenerate password using format: <code>mocu.program.number.year</code>
                            </div>
                        </div>

                        <!-- Supervisor/Admin Fields -->
                        <div id="supervisor-fields" style="display: {{ $user->role === 'student' ? 'none' : 'block' }};">
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="supervisor_phone" name="phone" value="{{ $user->phone }}" placeholder="0699889430">
                                <small class="text-muted">Required for SMS notifications</small>
                                @error('phone')
                                    <div class="text-danger">{{ $message }}</div>
                                @enderror
