...
<nav aria-label="breadcrumb" class="mb-3">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="{{ route('supervisor.interactions.index') }}">Interaction Tracking</a></li>
...
<div class="row">
    <div class="col-12">
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <a href="{{ route('supervisor.interactions.index') }}" class="btn btn-secondary">
