...
@section('title', 'Research Progress for ' . $student->name)

@section('content')
    <div class="container-fluid">
        <h1 class="h3 mb-4 text-gray-800">Research Progress: {{ $student->name }}</h1>
        ...
        <div class="mt-4">
            <a href="{{ route('supervisor.research-progress.index') }}" class="btn btn-secondary">
